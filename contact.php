        ...
        <section class="contact_area p_120">
            <div class="container">
                <div id="mapBox" class="mapBox" 
                    ...
                    data-lon="101.377150" 
                    data-zoom="11" 
                    data-info="Pekanbaru, Riau, Indonesia"
                    data-mlat="37.74"
                    data-mlon="49.3356">
                </div>
                <div class="row">
                    <div class="col-lg-3">
                        <div class="contact_info">
                            <div class="info_item">
                                ...
                                <h6>Indonesia</h6>
                                <p>Jl. Umban Sari ( Patin ) No. 1, Rumbai, Umban Sari, Rumbai, Kota Pekanbaru, Riau 28265 </p>
                            </div>
                            <div class="info_item">
                                <i class="lnr lnr-phone-handset"></i>
                                <h6><a href="#"> (0821) 5458 785</a></h6>
                                <p>Mon to Fri 9am to 6pm</p>
                            </div>
                            <div class="info_item">
                                <i class="lnr lnr-envelope"></i>
                                <h6><a href="#">dindarahayuu@gmail.com</a></h6>
                    ...
                    <div class="col-lg-9">
                        <form class="row contact_form" action="insert.php" method="post" id="contactForm" novalidate="novalidate">
                            ...
                            <div class="col-md-12 text-right">
                                <input type="submit" value="Send Message" class="btn submit_btn"></button>
                            </div>
                        </form>
                    </div>
                </div>
